...
void setGains() {
  stabGains.pitch[0] = 1;
  stabGains.pitch[1] = 0.2;
  stabGains.pitch[2] = 0.6;

  stabGains.roll[0] = 1;
  stabGains.roll[1] = 0.2;
  stabGains.roll[2] = 0.6;

  manualYawGain = 0.4;

  rateGains.pitch[0] = 1;
  rateGains.pitch[1] = 0.2;
  rateGains.pitch[2] = 0.6;

  rateGains.roll[0] = 1;
  rateGains.roll[1] = 0.2;
  rateGains.roll[2] = 0.6;
