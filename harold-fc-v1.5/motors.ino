...
void sendMotors() {
  frontLeftMotor.writeMicroseconds(constrain(receiverData.throttle + rateErrors.roll[3] + rateErrors.pitch[3] - rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print(constrain((receiverData.throttle / 5) + rateErrors.roll[3] + rateErrors.pitch[3] - rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print("\t");
  frontRightMotor.writeMicroseconds(constrain(receiverData.throttle - rateErrors.roll[3] + rateErrors.pitch[3] + rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print(constrain((receiverData.throttle / 5) - rateErrors.roll[3] + rateErrors.pitch[3] + rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print("\t");
  backLeftMotor.writeMicroseconds(constrain(receiverData.throttle + rateErrors.roll[3] - rateErrors.pitch[3] + rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print(constrain((receiverData.throttle / 5) + rateErrors.roll[3] - rateErrors.pitch[3] + rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print("\t");
  backRightMotor.writeMicroseconds(constrain(receiverData.throttle - rateErrors.roll[3] - rateErrors.pitch[3] - rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print(constrain((receiverData.throttle / 5) - rateErrors.roll[3] - rateErrors.pitch[3] - rateErrors.yaw[3], RC_CH3_MIN, RC_CH3_MAX));
  Serial.print("\n");
}
