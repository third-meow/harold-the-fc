...
void setGains() {
  ...
  rateGains.pitch[0] = 0.001;
  rateGains.pitch[1] = 0.0002;
  rateGains.pitch[2] = 0.0006;

  rateGains.roll[0] = 0.001;
  rateGains.roll[1] = 0.0002;
  rateGains.roll[2] = 0.0006;

  rateGains.yaw[0] = 0.001;
  rateGains.yaw[1] = 0.0002;
  rateGains.yaw[2] = 0.0006;
