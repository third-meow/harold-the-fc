...
void setGains() {
  stabGains.pitch[0] = 0.01;
  stabGains.pitch[1] = 0.002;
  stabGains.pitch[2] = 0.006;

  stabGains.roll[0] = 0.01;
  stabGains.roll[1] = 0.002;
  stabGains.roll[2] = 0.006;

  manualYawGain = 0.4;

  rateGains.pitch[0] = 0.01;
  rateGains.pitch[1] = 0.002;
  rateGains.pitch[2] = 0.006;

  rateGains.roll[0] = 0.01;
  rateGains.roll[1] = 0.002;
  rateGains.roll[2] = 0.006;

  rateGains.yaw[0] = 0.01;
  rateGains.yaw[1] = 0.002;
  rateGains.yaw[2] = 0.006;
