...
void doPIDs() {
  ...
  stabErrors.pitch[0] = (receiverData.pitch - euler.z()) * stabGains.pitch[0];                              //calculate P
  stabErrors.pitch[1] = stabErrors.pitch[1] + (receiverData.pitch - euler.z()) * stabGains.pitch[1];        //calculate I
