...
void setGains() {
  ...
  stabGains.pitch[1] = 0.006;
  stabGains.pitch[2] = 3;
  stabGains.roll[0] = 15;
  stabGains.roll[1] = 0.006;
  stabGains.roll[2] = 3;
  stabGains.yaw[0] = 10;
  
  rateGains.pitch[0] = 0.009;
  rateGains.pitch[1] = 0.000056;
  rateGains.roll[0] = 0.009;
  rateGains.roll[1] = 0.000056;
...
void doPIDs() {
  ...
  rateErrors.yaw[3] = rateErrors.yaw[0] + rateErrors.yaw[1];
}

void resetI(){
  rateErrors.pitch[1] = rateErrors.roll[1] = rateErrors.yaw[1] = 0;
  stabErrors.pitch[1] = stabErrors.roll[1] = stabErrors.yaw[1] = 0;
}
